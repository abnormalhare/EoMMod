...
public class ElementsItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:elements")
	public static final Item block = null;
	public ElementsItem(TheEomModModElements instance) {
		super(instance, 43);
	}
