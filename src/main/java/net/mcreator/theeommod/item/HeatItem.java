...
public class HeatItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:heat")
	public static final Item block = null;
	public HeatItem(TheEomModModElements instance) {
		super(instance, 25);
	}
