...
public class GravelElementItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:gravel_element")
	public static final Item block = null;
	public GravelElementItem(TheEomModModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("gravel_element");
		}
