...
public class SingularityItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:singularity")
	public static final Item block = null;
	public SingularityItem(TheEomModModElements instance) {
		super(instance, 51);
	}
