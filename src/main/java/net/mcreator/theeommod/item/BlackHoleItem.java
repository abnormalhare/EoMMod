...
public class BlackHoleItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:black_hole")
	public static final Item block = null;
	public BlackHoleItem(TheEomModModElements instance) {
		super(instance, 49);
	}
