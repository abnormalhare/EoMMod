...
public class FlintElementItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:flint_element")
	public static final Item block = null;
	public FlintElementItem(TheEomModModElements instance) {
		super(instance, 20);
	}
