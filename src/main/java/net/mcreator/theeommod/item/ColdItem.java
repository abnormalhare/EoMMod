...
public class ColdItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:cold")
	public static final Item block = null;
	public ColdItem(TheEomModModElements instance) {
		super(instance, 41);
	}
