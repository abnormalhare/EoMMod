...
public class WormholeItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:wormhole")
	public static final Item block = null;
	public WormholeItem(TheEomModModElements instance) {
		super(instance, 53);
	}
