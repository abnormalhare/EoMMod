...
public class TheFlintstonesItem extends TheEomModModElements.ModElement {
	@ObjectHolder("the_eom_mod:the_flintstones")
	public static final Item block = null;
	public TheFlintstonesItem(TheEomModModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("the_flintstones");
		}
